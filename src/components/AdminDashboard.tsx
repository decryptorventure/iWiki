        ...
        {[
          ...
          return (
            <button
              ...
              className={`flex items-center gap-2 px-6 py-4 text-sm font-semibold border-b-2 transition-all duration-200 ${activeTab === tab.id ? 'border-[#f76226] text-[#f76226]' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'}`}
            >
             ...
             <div className="space-y-4">
               {maintenanceArticles.map(m => (
                 <div key={m.id} className="flex flex-col sm:flex-row items-start justify-between p-4 border border-red-100 bg-red-50/30 rounded-xl">
                   ...
                   <div className="flex gap-2 mt-4 sm:mt-0">
                     <button className="px-4 py-2 text-sm font-bold text-white bg-[#f76226] hover:bg-orange-600 rounded-lg transition-colors">Yêu cầu Update</button>
