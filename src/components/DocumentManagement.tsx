    ...
    <div className="flex h-full bg-white">
      ...
      <div className="w-72 border-r border-gray-200/80 flex flex-col bg-[#f9fafb]">
        <div className="p-4 border-b border-gray-200/80 flex items-center justify-between bg-white">
          ...
          <button className="p-1.5 text-gray-500 hover:text-[#f76226] hover:bg-orange-50 rounded-lg transition-all duration-200 active:scale-90">
            <FolderPlus size={18} />
          </button>
        </div>
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#f76226]/20 focus:border-[#f76226] transition-all duration-200 hover:border-gray-300"
              />
            </div>
            <button className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#f76226] to-[#FF8A6A] text-white text-sm font-bold rounded-xl hover:shadow-lg hover:shadow-[#f76226]/20 transition-all duration-200 shadow-md active:scale-95">
              <FilePlus size={18} />
              Tải lên
            </button>
          </div>
