...
export default function NotificationBell() {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case 'bounty':
        return <Target size={14} className="text-[#FF6B4A]" />;
      default:
        ...
        <div className="absolute right-0 mt-2 w-[360px] max-w-[90vw] rounded-2xl border border-gray-200 bg-white shadow-xl z-30 overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs font-semibold text-gray-500 hover:text-[#FF6B4A] transition-colors"
            >
              Đánh dấu đã đọc
            </button>
          </div>
          ...
          <div className="px-4 py-2.5 bg-gray-50 border-t border-gray-100">
            <button
              ...
              className="w-full text-sm font-semibold text-[#FF6B4A] hover:text-[#e55a2b] transition-colors"
            >
